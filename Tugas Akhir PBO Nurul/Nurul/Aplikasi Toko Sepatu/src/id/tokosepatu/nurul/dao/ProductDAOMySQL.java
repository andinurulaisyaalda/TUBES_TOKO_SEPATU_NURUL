 ...
 */
package id.tokosepatu.nurul.dao;
...
public class ProductDAOMySQL implements ProductDAO{
    ...
    public boolean insert(Product p) {
        ...
        try {
            ...
            statement.setInt(5, p.getUkuran());
    ...
    public boolean update(Product p) {
        ...
        String sql="Update product set name='"+p.getName()+"', price='"+p.getPrice()+"',stock='"+p.getStock()+"',ukuran='"+p.getUkuran()+"', category='"+Integer.parseInt(p.getCategory().getId())+"' where id='"+p.getId()+"' ";
